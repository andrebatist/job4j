...
public class StoreTest {
    ...
    public void whenStoresThenResult() {
        ...
        UserStore<User> userStore = new UserStore<>(new SimpleArray<>(4));
        userStore.add(user);
        userStore.add(user2);
        User searchUser = (User) userStore.findById("2");
        ...
        RoleStore<Role> roleStore = new RoleStore<>(new SimpleArray<>(4));
        roleStore.add(role);
        roleStore.add(role2);
        Role searchRole = (Role) roleStore.findById("2");

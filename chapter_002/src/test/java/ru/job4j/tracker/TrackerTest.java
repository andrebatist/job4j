...
public class TrackerTest {
    ...
    public void deleteSecondItem() {
        ...
        assertThat(tracker.getItems().get(1).getName(), is("testDescription3"));
    }
    ...
    public void deleteFirstItem() {
        ...
        tracker.add(new Item("test1", "testDescription", 123L));
        tracker.add(new Item("test2", "testDescription2", 123L));
        tracker.delete(tracker.getItems().get(0).getId());
        assertThat(tracker.getItems().get(0).getName(), is("testDescription2"));
    }
    ...
    public void findByNameResTwo() {
        ...
        List<Item> res = tracker.findByName("testDescription");
        assertThat(res.size(), is(2));
        assertThat(res.get(0).getName(), is("testDescription"));
        assertThat(res.get(1).getName(), is("testDescription"));
    }
    ...
    public void findByIdResult() {
        ...
        tracker.add(new Item("test1", "text", 123L));
        tracker.add(new Item("test2", "testDescription2", 123L));
        Item res = tracker.findById(tracker.getItems().get(0).getId());

...
public class SortUserTest {
    ...
    public void when3Users() {
        ...
        Set expect = Set.of(user3, user2, user);
    ...
    public void when5UsersSortByNameLength() {
        ...
        List<User> users = new ArrayList<>(List.of(user, user2, user3, user4, user5));
        List result = new SortUser().sortNameLength(users);
        List expect = List.of(user4, user5, user, user3, user2);
        assertThat(result, is(expect));
    }
    ...
    public void when4UsersSortByAllFields() {
        ...
        List<User> users = new ArrayList<>(List.of(user, user2, user3, user4));
        List result = new SortUser().sortByAllFields(users);
        List expect = List.of(user4, user2, user3, user);
        assertThat(result, is(expect));
    }
}